...
var require_es_global_this = __commonJS({
  "node_modules/core-js/modules/es.global-this.js"() {
    ...
    var global3 = require_global();
    $2({ global: true, forced: global3.globalThis !== global3 }, {
      globalThis: global3
    });
  }
});
...
var require_create_babel_parse_error = __commonJS2({
  "src/language-js/parse/utils/create-babel-parse-error.js"(exports, module) {
    "use strict";
    init_define_process();
...
var require_json = __commonJS2({
  "src/language-js/parse/json.js"(exports, module) {
    "use strict";
    init_define_process();
    var isNonEmptyArray = require_is_non_empty_array();
    var createError = require_parser_create_error();
...
var require_babel = __commonJS2({
  "src/language-js/parse/babel.js"(exports, module) {
    init_define_process();
...
var parser_babel_js_esm_default = require_babel();
export {
  parser_babel_js_esm_default as default
};
