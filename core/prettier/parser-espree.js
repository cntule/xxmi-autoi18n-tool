(function (factory) {
  if (typeof exports === "object" && typeof module === "object") {
    ...
    root.prettierPlugins.espree = factory();
  }
})(function() {
  "use strict";
  ...
  // dist/_parser-espree.js.umd.js
  var require_parser_espree_js_umd = __commonJS({
    "dist/_parser-espree.js.umd.js"(exports, module) {
      ...
      var require_try_combinations = __commonJS2({
        "src/utils/try-combinations.js"(exports2, module2) {
          ...
          module2.exports = tryCombinations;
        }
      });
      var os_exports = {};
      __export(os_exports, {
...
` : "") + normalizeEndOfLine(docBlock) + (strippedText.startsWith("\n") ? "\n" : "\n\n") + strippedText;
      ...
      var require_acorn_jsx = __commonJS2({
        "node_modules/acorn-jsx/index.js"(exports2, module2) {
          ...
          function getJsxTokens(acorn2) {
            ...
            let acornJsx = acornJsxMap.get(acorn2);
            if (!acornJsx) {
              ...
              acornJsxMap.set(acorn2, acornJsx);
            }
            return acornJsx;
          }
          ...
          function plugin(options, Parser) {
            const acorn2 = Parser.acorn || require_acorn();
            const acornJsx = getJsxTokens(acorn2);
            const tt = acorn2.tokTypes;
      ...
      var require_acorn2 = __commonJS2({
        "src/language-js/parse/acorn.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var createError = require_parser_create_error();
          ...
          module2.exports = createParser(parse);
        }
      });
      var require_replace_hashbang = __commonJS2({
        "src/language-js/parse/utils/replace-hashbang.js"(exports2, module2) {
          "use strict";
          init_define_process();
          ...
          module2.exports = replaceHashbang;
        }
      });
      var require_espree = __commonJS2({
        "node_modules/espree/dist/espree.cjs"(exports2) {
          "use strict";
          init_define_process();
          Object.defineProperty(exports2, "__esModule", {
            value: true
          });
          var acorn2 = require_acorn();
          ...
          var parsers = {
            ...
            get regular() {
              if (this._regular === null) {
                this._regular = acorn__namespace.Parser.extend(espree2());
              }
              return this._regular;
            },
            get jsx() {
              if (this._jsx === null) {
                this._jsx = acorn__namespace.Parser.extend(jsx__default["default"](), espree2());
              }
              return this._jsx;
            },
            get(options) {
      ...
      var require_espree2 = __commonJS2({
        "src/language-js/parse/espree.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var createError = require_parser_create_error();
          var tryCombinations = require_try_combinations();
  ...
  return require_parser_espree_js_umd();
});