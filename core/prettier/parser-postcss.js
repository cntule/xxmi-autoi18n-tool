(function (factory) {
  if (typeof exports === "object" && typeof module === "object") {
    ...
    root.prettierPlugins.postcss = factory();
  }
})(function() {
  "use strict";
  ...
  // dist/_parser-postcss.js.umd.js
  var require_parser_postcss_js_umd = __commonJS({
    "dist/_parser-postcss.js.umd.js"(exports, module) {
...
` : "") + normalizeEndOfLine(docBlock) + (strippedText.startsWith("\n") ? "\n" : "\n\n") + strippedText;
      ...
      var require_pragma2 = __commonJS2({
        "src/language-css/pragma.js"(exports2, module2) {
          ...
          var parseFrontMatter2 = require_parse();
          function hasPragma2(text) {
            return jsPragma.hasPragma(parseFrontMatter2(text).content);
          }
          function insertPragma(text) {
            const {
              frontMatter,
              content
            } = parseFrontMatter2(text);
      ...
      var require_loc = __commonJS2({
        "src/language-css/loc.js"(exports2, module2) {
          ...
          function calculateLocEnd(node, text) {
            ...
            const endNode = node.nodes && getLast2(node.nodes);
          ...
          function calculateLoc2(node, text) {
            if (node.source) {
          ...
          function replaceQuotesInInlineComments2(text) {
            let state = "initial";
          ...
          module2.exports = {
            locStart: locStart2,
            locEnd: locEnd2,
            calculateLoc: calculateLoc2,
            replaceQuotesInInlineComments: replaceQuotesInInlineComments2
          };
        }
      });
      ...
      var require_has_scss_interpolation = __commonJS2({
        "src/language-css/utils/has-scss-interpolation.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var isNonEmptyArray = require_is_non_empty_array();
          function hasSCSSInterpolation2(groupList) {
          ...
          module2.exports = hasSCSSInterpolation2;
        }
      });
      var require_has_string_or_function = __commonJS2({
        "src/language-css/utils/has-string-or-function.js"(exports2, module2) {
          "use strict";
          init_define_process();
          function hasStringOrFunction2(groupList) {
            return groupList.some((group) => group.type === "string" || group.type === "func");
          }
          module2.exports = hasStringOrFunction2;
        }
      });
      var require_is_less_parser = __commonJS2({
        "src/language-css/utils/is-less-parser.js"(exports2, module2) {
          "use strict";
          init_define_process();
          function isLessParser2(options) {
            return options.parser === "css" || options.parser === "less";
          }
          module2.exports = isLessParser2;
        }
      });
      var require_is_scss = __commonJS2({
        "src/language-css/utils/is-scss.js"(exports2, module2) {
          "use strict";
          init_define_process();
          function isSCSS2(parser, text) {
            const hasExplicitParserChoice = parser === "less" || parser === "scss";
            const IS_POSSIBLY_SCSS = /(?:\w\s*:\s*[^:}]+|#){|@import[^\n]+(?:url|,)/;
            return hasExplicitParserChoice ? parser === "scss" : IS_POSSIBLY_SCSS.test(text);
          }
          module2.exports = isSCSS2;
        }
      });
      var require_is_scss_nested_property_node = __commonJS2({
        "src/language-css/utils/is-scss-nested-property-node.js"(exports2, module2) {
          "use strict";
          init_define_process();
          function isSCSSNestedPropertyNode2(node) {
            if (!node.selector) {
              return false;
            }
            return node.selector.replace(/\/\*.*?\*\//, "").replace(/\/\/.*\n/, "").trim().endsWith(":");
          }
          module2.exports = isSCSSNestedPropertyNode2;
        }
      });
      var require_is_scss_variable = __commonJS2({
        "src/language-css/utils/is-scss-variable.js"(exports2, module2) {
          "use strict";
          init_define_process();
          function isSCSSVariable2(node) {
            return Boolean((node === null || node === void 0 ? void 0 : node.type) === "word" && node.value.startsWith("$"));
          }
          module2.exports = isSCSSVariable2;
        }
      });
      var require_stringify_node = __commonJS2({
        "src/language-css/utils/stringify-node.js"(exports2, module2) {
          "use strict";
          init_define_process();
          function stringifyNode2(node) {
            ...
            if (node.groups) {
              ...
              const groups = node.groups.map((currentValue) => stringifyNode2(currentValue)).join(((_node$groups$ = node.groups[0]) === null || _node$groups$ === void 0 ? void 0 : _node$groups$.type) === "comma_group" ? "," : "");
            ...
            const group = node.group ? stringifyNode2(node.group) : "";
          ...
          module2.exports = stringifyNode2;
        }
      });
      var require_is_module_rule_name = __commonJS2({
        "src/language-css/utils/is-module-rule-name.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var moduleRuleNames = /* @__PURE__ */ new Set(["import", "use", "forward"]);
          function isModuleRuleName2(name) {
            return moduleRuleNames.has(name);
          }
          module2.exports = isModuleRuleName2;
        }
      });
      var require_node = __commonJS2({
        "node_modules/postcss-values-parser/lib/node.js"(exports2, module2) {
          "use strict";
          init_define_process();
      ...
      var require_container = __commonJS2({
        "node_modules/postcss-values-parser/lib/container.js"(exports2, module2) {
          "use strict";
          init_define_process();
      ...
      var require_root = __commonJS2({
        "node_modules/postcss-values-parser/lib/root.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var Container = require_container();
          module2.exports = class Root extends Container {
            constructor(opts) {
              super(opts);
              this.type = "root";
            }
      ...
      var require_value = __commonJS2({
        "node_modules/postcss-values-parser/lib/value.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var Container = require_container();
          module2.exports = class Value extends Container {
            constructor(opts) {
              super(opts);
              this.type = "value";
              this.unbalanced = 0;
      ...
      var require_atword = __commonJS2({
        "node_modules/postcss-values-parser/lib/atword.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var Container = require_container();
          ...
          module2.exports = AtWord;
        }
      });
      var require_colon = __commonJS2({
        "node_modules/postcss-values-parser/lib/colon.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var Container = require_container();
          var Node = require_node();
      ...
      var require_comma = __commonJS2({
        "node_modules/postcss-values-parser/lib/comma.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var Container = require_container();
          var Node = require_node();
          ...
          module2.exports = Comma;
        }
      });
      var require_comment = __commonJS2({
        "node_modules/postcss-values-parser/lib/comment.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var Container = require_container();
          var Node = require_node();
      ...
      var require_function = __commonJS2({
        "node_modules/postcss-values-parser/lib/function.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var Container = require_container();
      ...
      var require_number = __commonJS2({
        "node_modules/postcss-values-parser/lib/number.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var Container = require_container();
          var Node = require_node();
          ...
          module2.exports = NumberNode;
        }
      });
      var require_operator = __commonJS2({
        "node_modules/postcss-values-parser/lib/operator.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var Container = require_container();
          var Node = require_node();
          ...
          module2.exports = Operator;
        }
      });
      var require_paren = __commonJS2({
        "node_modules/postcss-values-parser/lib/paren.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var Container = require_container();
          var Node = require_node();
      ...
      var require_string = __commonJS2({
        "node_modules/postcss-values-parser/lib/string.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var Container = require_container();
          var Node = require_node();
          ...
          module2.exports = StringNode;
        }
      });
      var require_word = __commonJS2({
        "node_modules/postcss-values-parser/lib/word.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var Container = require_container();
          var Node = require_node();
      ...
      var require_unicode_range = __commonJS2({
        "node_modules/postcss-values-parser/lib/unicode-range.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var Container = require_container();
          var Node = require_node();
      ...
      var require_TokenizeError = __commonJS2({
        "node_modules/postcss-values-parser/lib/errors/TokenizeError.js"(exports2, module2) {
          "use strict";
          init_define_process();
          ...
          module2.exports = TokenizeError;
        }
      });
      var require_tokenize = __commonJS2({
        "node_modules/postcss-values-parser/lib/tokenize.js"(exports2, module2) {
          "use strict";
          init_define_process();
          ...
          module2.exports = function tokenize(input, options) {
            options = options || {};
      ...
      var require_flatten = __commonJS2({
        "node_modules/flatten/index.js"(exports2, module2) {
          init_define_process();
      ...
      var require_indexes_of = __commonJS2({
        "node_modules/indexes-of/index.js"(exports2, module2) {
          init_define_process();
          module2.exports = function(ary, item) {
            var i = -1, indexes = [];
      ...
      var require_ParserError = __commonJS2({
        "node_modules/postcss-values-parser/lib/errors/ParserError.js"(exports2, module2) {
          "use strict";
          init_define_process();
      ...
      var require_parser = __commonJS2({
        "node_modules/postcss-values-parser/lib/parser.js"(exports2, module2) {
          "use strict";
          init_define_process();
      ...
      var require_lib = __commonJS2({
        "node_modules/postcss-values-parser/lib/index.js"(exports2, module2) {
          "use strict";
          init_define_process();
      ...
      var require_types = __commonJS2({
        "node_modules/postcss-selector-parser/dist/selectors/types.js"(exports2) {
          ...
          init_define_process();
          exports2.__esModule = true;
          var TAG = exports2.TAG = "tag";
          var STRING = exports2.STRING = "string";
          var SELECTOR = exports2.SELECTOR = "selector";
          var ROOT = exports2.ROOT = "root";
          var PSEUDO = exports2.PSEUDO = "pseudo";
          var NESTING = exports2.NESTING = "nesting";
          var ID = exports2.ID = "id";
          var COMMENT = exports2.COMMENT = "comment";
          var COMBINATOR = exports2.COMBINATOR = "combinator";
          var CLASS = exports2.CLASS = "class";
          var ATTRIBUTE = exports2.ATTRIBUTE = "attribute";
          var UNIVERSAL = exports2.UNIVERSAL = "universal";
        }
      });
      ...
      var require_attribute = __commonJS2({
        "node_modules/postcss-selector-parser/dist/selectors/attribute.js"(exports2, module2) {
          "use strict";
          init_define_process();
          exports2.__esModule = true;
          var _namespace = require_namespace();
      ...
      var require_tokenize2 = __commonJS2({
        "node_modules/postcss-selector-parser/dist/tokenize.js"(exports2, module2) {
          "use strict";
          init_define_process();
          exports2.__esModule = true;
      ...
      var require_Node = __commonJS2({
        "node_modules/postcss-media-query-parser/dist/nodes/Node.js"(exports2) {
          "use strict";
          init_define_process();
          Object.defineProperty(exports2, "__esModule", {
            value: true
      ...
      var require_Container = __commonJS2({
        "node_modules/postcss-media-query-parser/dist/nodes/Container.js"(exports2) {
          "use strict";
          init_define_process();
          Object.defineProperty(exports2, "__esModule", {
            value: true
      ...
      var require_parsers = __commonJS2({
        "node_modules/postcss-media-query-parser/dist/parsers.js"(exports2) {
          "use strict";
          init_define_process();
          Object.defineProperty(exports2, "__esModule", {
            value: true
          });
          exports2.parseMediaFeature = parseMediaFeature;
          exports2.parseMediaQuery = parseMediaQuery2;
          exports2.parseMediaList = parseMediaList;
          var _Node = require_Node();
          var _Node2 = _interopRequireDefault(_Node);
      ...
      var require_dist2 = __commonJS2({
        "node_modules/postcss-media-query-parser/dist/index.js"(exports2) {
          "use strict";
          init_define_process();
          Object.defineProperty(exports2, "__esModule", {
            value: true
          });
          exports2.default = parseMedia;
          var _Container = require_Container();
          var _Container2 = _interopRequireDefault(_Container);
      ...
      var require_path = __commonJS2({
        "node-modules-polyfills-commonjs:path"(exports2, module2) {
          init_define_process();
      ...
      var require_inline_comment = __commonJS2({
        "node_modules/postcss-less/lib/nodes/inline-comment.js"(exports2, module2) {
          init_define_process();
            ...
            isInlineComment(token) {
              if (token[0] === "word" && token[1].slice(0, 2) === "//") {
                ...
                if (next[0] === "comment" && /^\/\*/.test(next[1])) {
                  ...
                  return module2.exports.isInlineComment.bind(this)(token);
                }
              }
              return false;
            }
      ...
      var require_interpolation = __commonJS2({
        "node_modules/postcss-less/lib/nodes/interpolation.js"(exports2, module2) {
          init_define_process();
          module2.exports = {
            interpolation(token) {
              let first = token;
      ...
      var require_mixin = __commonJS2({
        "node_modules/postcss-less/lib/nodes/mixin.js"(exports2, module2) {
          init_define_process();
      ...
      var require_import = __commonJS2({
        "node_modules/postcss-less/lib/nodes/import.js"(exports2, module2) {
          init_define_process();
      ...
      var require_variable = __commonJS2({
        "node_modules/postcss-less/lib/nodes/variable.js"(exports2, module2) {
          init_define_process();
          var afterPattern = /:$/;
          var beforePattern = /^:(\s+)?/;
          module2.exports = (node) => {
      ...
      var require_LessParser = __commonJS2({
        "node_modules/postcss-less/lib/LessParser.js"(exports2, module2) {
          init_define_process();
          ...
          module2.exports = class LessParser extends Parser {
            constructor() {
              super(...arguments);
              this.lastNode = null;
            }
      ...
      var require_LessStringifier = __commonJS2({
        "node_modules/postcss-less/lib/LessStringifier.js"(exports2, module2) {
          init_define_process();
          var Stringifier = require_stringifier();
          module2.exports = class LessStringifier extends Stringifier {
      ...
      var require_lib2 = __commonJS2({
        "node_modules/postcss-less/lib/index.js"(exports2, module2) {
          init_define_process();
          var Input = require_input();
          ...
          module2.exports = {
            ...
            nodeToString(node) {
              let result = "";
              module2.exports.stringify(node, (bit) => {
                result += bit;
              });
              return result;
            }
  ...
  return require_parser_postcss_js_umd();
});