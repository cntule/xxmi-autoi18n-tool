(function (factory) {
  if (typeof exports === "object" && typeof module === "object") {
    ...
    root.prettierPlugins.angular = factory();
  }
})(function() {
  "use strict";
  ...
  // dist/_parser-angular.js.umd.js
  var require_parser_angular_js_umd = __commonJS({
    "dist/_parser-angular.js.umd.js"(exports, module) {
        ...
        "src/language-js/loc.js"(exports2, module2) {
          ...
          function locStart2(node) {
            ...
            if (isNonEmptyArray(decorators)) {
              return Math.min(locStart2(decorators[0]), start);
            }
            return start;
          }
          ...
          function hasSameLocStart(nodeA, nodeB) {
            const nodeAStart = locStart2(nodeA);
            return Number.isInteger(nodeAStart) && nodeAStart === locStart2(nodeB);
          }
          function hasSameLocEnd(nodeA, nodeB) {
            const nodeAEnd = locEnd2(nodeA);
            return Number.isInteger(nodeAEnd) && nodeAEnd === locEnd2(nodeB);
          }
      ...
      var require_build = __commonJS2({
        "node_modules/angular-estree-parser/node_modules/lines-and-columns/build/index.js"(exports2) {
          "use strict";
          init_define_process();
      ...
      var require_context = __commonJS2({
        "node_modules/angular-estree-parser/lib/context.js"(exports2) {
          "use strict";
          init_define_process();
      ...
      var require_utils = __commonJS2({
        "node_modules/angular-estree-parser/lib/utils.js"(exports2) {
          "use strict";
          init_define_process();
          Object.defineProperty(exports2, "__esModule", {
            value: true
          });
          exports2.getLast = exports2.toLowerCamelCase = exports2.findBackChar = exports2.findFrontChar = exports2.fitSpans = exports2.getNgType = exports2.parseNgInterpolation = exports2.parseNgTemplateBindings = exports2.parseNgAction = exports2.parseNgSimpleBinding = exports2.parseNgBinding = exports2.NG_PARSE_TEMPLATE_BINDINGS_FAKE_PREFIX = void 0;
          ...
          exports2.NG_PARSE_TEMPLATE_BINDINGS_FAKE_PREFIX = "NgEstreeParser";
          ...
          exports2.parseNgBinding = parseNgBinding;
          ...
          exports2.parseNgSimpleBinding = parseNgSimpleBinding;
          function parseNgAction(input) {
            return parseNg(input, (astInput, ngParser) => ngParser.parseAction(astInput, ...NG_PARSE_SHARED_PARAMS));
          }
          exports2.parseNgAction = parseNgAction;
          function parseNgTemplateBindings(input) {
            const ngParser = createNgParser();
            const {
              templateBindings: ast,
              errors
            } = ngParser.parseTemplateBindings(exports2.NG_PARSE_TEMPLATE_BINDINGS_FAKE_PREFIX, input, NG_PARSE_FAKE_LOCATION, NG_PARSE_FAKE_ABSOLUTE_OFFSET, NG_PARSE_FAKE_ABSOLUTE_OFFSET);
            assertAstErrors(errors);
            return ast;
          }
          exports2.parseNgTemplateBindings = parseNgTemplateBindings;
          ...
          exports2.parseNgInterpolation = parseNgInterpolation;
          ...
          exports2.findFrontChar = findFrontChar;
          ...
          exports2.findBackChar = findBackChar;
      ...
      var require_transform = __commonJS2({
        "node_modules/angular-estree-parser/lib/transform.js"(exports2) {
          "use strict";
          init_define_process();
          Object.defineProperty(exports2, "__esModule", {
            value: true
          });
          exports2.transformSpan = exports2.transform = void 0;
          ...
          var transform = function(node, context) {
            ...
            function _t(n) {
              return exports2.transform(n, context);
            }
            function _transformHasParentParens(n) {
              return exports2.transform(n, context, true);
            }
      ...
      var require_transform_microsyntax = __commonJS2({
        "node_modules/angular-estree-parser/lib/transform-microsyntax.js"(exports2) {
          "use strict";
          init_define_process();
          Object.defineProperty(exports2, "__esModule", {
            value: true
          });
          exports2.transformTemplateBindings = void 0;
          var ng = (init_ast(), __toCommonJS(ast_exports));
          ...
          exports2.transformTemplateBindings = transformTemplateBindings;
        }
      });
      var require_lib = __commonJS2({
        "node_modules/angular-estree-parser/lib/index.js"(exports2) {
          "use strict";
          init_define_process();
          Object.defineProperty(exports2, "__esModule", {
            value: true
          });
          exports2.parseTemplateBindings = exports2.parseAction = exports2.parseInterpolation = exports2.parseSimpleBinding = exports2.parseBinding = void 0;
          ...
          exports2.parseTemplateBindings = parseTemplateBindings;
        }
      });
      init_define_process();
      var {
  ...
  return require_parser_angular_js_umd();
});