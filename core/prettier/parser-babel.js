(function (factory) {
  if (typeof exports === "object" && typeof module === "object") {
    ...
    root.prettierPlugins.babel = factory();
  }
})(function() {
  "use strict";
  ...
  // dist/_parser-babel.js.umd.js
  var require_parser_babel_js_umd = __commonJS({
    "dist/_parser-babel.js.umd.js"(exports, module) {
      ...
      var require_get_next_non_space_non_comment_character_index_with_start_index = __commonJS2({
        "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(exports2, module2) {
          ...
          function getNextNonSpaceNonCommentCharacterIndexWithStartIndex2(text, idx) {
            let oldIdx = null;
            let nextIdx = idx;
          ...
          module2.exports = getNextNonSpaceNonCommentCharacterIndexWithStartIndex2;
        }
      });
      var os_exports = {};
      __export(os_exports, {
      ...
      var require_pragma = __commonJS2({
        "src/language-js/pragma.js"(exports2, module2) {
          ...
          var getShebang2 = require_get_shebang();
          function parseDocBlock(text) {
            const shebang = getShebang2(text);
            if (shebang) {
...
` : "") + normalizeEndOfLine(docBlock) + (strippedText.startsWith("\n") ? "\n" : "\n\n") + strippedText;
      ...
      var require_create_babel_parse_error = __commonJS2({
        "src/language-js/parse/utils/create-babel-parse-error.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var createError = require_parser_create_error();
          function createBabelParseError2(error) {
            const {
              message,
              loc
            } = error;
          ...
          module2.exports = createBabelParseError2;
        }
      });
      var require_is_ts_keyword_type = __commonJS2({
        "src/language-js/utils/is-ts-keyword-type.js"(exports2, module2) {
          "use strict";
          init_define_process();
          function isTsKeywordType(_ref4) {
            let {
              type: type2
            } = _ref4;
      ...
      var require_lib = __commonJS2({
        "node_modules/@babel/parser/lib/index.js"(exports2) {
          ...
          var reflect = function(keys) {
            let last = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : keys.length - 1;
            return {
              get() {
          ...
          var instantiate = (constructor, properties, descriptors) => Object.keys(descriptors).map((key) => [key, descriptors[key]]).filter((_ref5) => {
            let [, descriptor] = _ref5;
            return !!descriptor;
          }).map((_ref6) => {
            let [key, descriptor] = _ref6;
          ...
          }).reduce((instance, _ref7) => {
            let [key, descriptor] = _ref7;
          ...
          var toNodeDescription = (_ref8) => {
            let {
              type: type2,
              prefix: prefix2
            } = _ref8;
            return type2 === "UpdateExpression" ? NodeDescriptions.UpdateExpression[String(prefix2)] : NodeDescriptions[type2];
          };
          var StandardErrors = {
            AccessorIsGenerator: (_ref9) => {
              let {
                kind
              } = _ref9;
            ...
            DeclarationMissingInitializer: (_ref10) => {
              let {
                kind
              } = _ref10;
...
- Did you mean \`export { '${localName}' as '${exportName}' } from 'some-module'\`?`;
            ...
            ForInOfLoopInitializer: (_ref13) => {
              let {
                type: type2
              } = _ref13;
              return `'${type2 === "ForInStatement" ? "for-in" : "for-of"}' loop variable declaration may not have an initializer.`;
            },
            ForInUsing: "For-in loop may not start with 'using' declaration.",
            ForOfAsync: "The left-hand side of a for-of loop may not be 'async'.",
            ForOfLet: "The left-hand side of a for-of loop may not start with 'let'.",
            GeneratorInSingleStatementContext: "Generators can only be declared at the top level or inside a block.",
            IllegalBreakContinue: (_ref14) => {
              let {
                type: type2
              } = _ref14;
              return `Unsyntactic ${type2 === "BreakStatement" ? "break" : "continue"}.`;
            },
            IllegalLanguageModeDirective: "Illegal 'use strict' directive in function with non-simple parameter list.",
            IllegalReturn: "'return' outside of function.",
            ImportBindingIsString: (_ref15) => {
              let {
                importName
              } = _ref15;
...
- Did you mean \`import { "${importName}" as foo }\`?`;
            ...
            InvalidEscapedReservedWord: (_ref18) => {
              let {
                reservedWord
              } = _ref18;
              return `Escape sequence in keyword ${reservedWord}.`;
            },
            InvalidIdentifier: (_ref19) => {
              let {
                identifierName
              } = _ref19;
            ...
            InvalidOrUnexpectedToken: (_ref22) => {
              let {
                unexpected
              } = _ref22;
            ...
            InvalidPrivateFieldResolution: (_ref23) => {
              let {
                identifierName
              } = _ref23;
            ...
            UnsupportedMetaProperty: (_ref35) => {
              let {
                target,
          ...
          var StrictModeErrors = {
            ...
            StrictEvalArguments: (_ref37) => {
              let {
                referenceName
              } = _ref37;
              return `Assigning to '${referenceName}' in strict mode.`;
            },
            StrictEvalArgumentsBinding: (_ref38) => {
              let {
                bindingName
              } = _ref38;
          ...
          var PipelineOperatorErrors = {
            ...
            PipeTopicUnconfiguredToken: (_ref39) => {
              let {
                token
              } = _ref39;
            ...
            PipeUnparenthesizedBody: (_ref40) => {
              let {
                type: type2
              } = _ref40;
          ...
          var estree = (superClass) => class ESTreeParserMixin extends superClass {
            ...
            parseFunctionBody(node, allowExpression) {
              let isMethod = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
              super.parseFunctionBody(node, allowExpression, isMethod);
              node.expression = node.body.type !== "BlockStatement";
            }
            parseMethod(node, isGenerator, isAsync, isConstructor, allowDirectSuper, type2) {
              let inClassScope = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : false;
            ...
            toAssignable(node) {
              let isLHS = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
              if (node != null && this.isObjectProperty(node)) {
                const {
                  key,
                  value
            ...
            resetEndLocation(node) {
              let endLoc = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.state.lastTokEndLoc;
          ...
          var Tokenizer = class extends CommentsParser {
            ...
            setStrict(strict) {
              ...
              if (strict) {
                this.state.strictErrors.forEach((_ref44) => {
                  let [toParseError, at] = _ref44;
            ...
            readInt(radix, len) {
              let forceLen = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
              let allowNumSeparator = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true;
              const {
                n,
                pos
            ...
            recordStrictModeErrors(toParseError, _ref45) {
              let {
                at
              } = _ref45;
          ...
          var ExpressionScope = class {
            constructor() {
              let type2 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : kExpression;
              this.type = void 0;
              this.type = type2;
            }
          ...
          var ArrowHeadParsingScope = class extends ExpressionScope {
            ...
            recordDeclarationError(ParsingErrorClass, _ref46) {
              let {
                at
              } = _ref46;
              const index = at.index;
          ...
          var ExpressionScopeHandler = class {
            ...
            recordParameterInitializerError(toParseError, _ref47) {
              let {
                at: node
              } = _ref47;
              const origin = {
            ...
            recordArrowParameterBindingError(error, _ref48) {
              let {
                at: node
              } = _ref48;
              const {
            ...
            recordAsyncArrowParametersError(_ref49) {
              let {
                at
              } = _ref49;
              const {
            ...
            validateAsPattern() {
              ...
              if (!currentScope.canBeArrowParameterDeclaration())
                return;
              currentScope.iterateErrors((_ref50) => {
                let [toParseError, loc] = _ref50;
          ...
          var UtilParser = class extends Tokenizer {
            ...
            semicolon() {
              let allowAsi = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
            ...
            tryParse(fn) {
              let oldState = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.state.clone();
              const abortSignal = {
                node: null
              };
              try {
                const node = fn(function() {
                  let node2 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null;
            ...
            initializeScopes() {
              let inModule = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : this.options.sourceType === "module";
          ...
          var FlowErrors = ParseErrorEnum`flow`({
            ...
            EnumBooleanMemberNotInitialized: (_ref52) => {
              let {
                memberName,
                enumName
              } = _ref52;
            ...
            EnumDuplicateMemberName: (_ref53) => {
              let {
                memberName,
                enumName
              } = _ref53;
            ...
            EnumInconsistentMemberValues: (_ref54) => {
              let {
                enumName
              } = _ref54;
            ...
            EnumInvalidExplicitType: (_ref55) => {
              let {
                invalidEnumType,
                enumName
              } = _ref55;
            ...
            EnumInvalidMemberInitializerSymbolType: (_ref58) => {
              let {
                enumName,
                memberName
              } = _ref58;
            ...
            EnumInvalidMemberInitializerUnknownType: (_ref59) => {
              let {
                enumName,
                memberName
              } = _ref59;
            ...
            EnumNumberMemberNotInitialized: (_ref61) => {
              let {
                enumName,
                memberName
              } = _ref61;
            ...
            EnumStringMemberInconsistentlyInitailized: (_ref62) => {
              let {
                enumName
              } = _ref62;
            ...
            UnsupportedDeclareExportKind: (_ref64) => {
              let {
          ...
          var flow = (superClass) => class FlowParserMixin extends superClass {
            ...
            finishToken(type2, val) {
              if (type2 !== 131 && type2 !== 13 && type2 !== 28) {
            ...
            addComment(comment) {
              if (this.flowPragma === void 0) {
                const matches = FLOW_PRAGMA_REGEX2.exec(comment.value);
                if (!matches)
                  ;
            ...
            flowParseTypeParameter() {
              let requireDefault = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
            ...
            parseFunctionBodyAndFinish(node, type2) {
              let isMethod = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
              if (this.match(14)) {
                const typeNode = this.startNode();
            ...
            shouldParseExportDeclaration() {
              ...
              if (tokenIsFlowInterfaceOrTypeOrOpaque(type2) || this.shouldParseEnums() && type2 === 124) {
            ...
            checkParams(node, allowDuplicates, isArrowFunction) {
              let strictModeChanged = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true;
            ...
            flowEnumErrorBooleanMemberNotInitialized(loc, _ref66) {
              let {
                enumName,
                memberName
              } = _ref66;
            ...
            flowEnumErrorNumberMemberNotInitialized(loc, _ref67) {
              let {
                enumName,
                memberName
              } = _ref67;
            ...
            flowEnumErrorStringMemberInconsistentlyInitailized(node, _ref68) {
              let {
                enumName
              } = _ref68;
            ...
            flowEnumStringMembers(initializedMembers, defaultedMembers, _ref70) {
              let {
                enumName
              } = _ref70;
            ...
            flowEnumParseExplicitType(_ref71) {
              let {
                enumName
              } = _ref71;
          ...
          var JsxErrors = ParseErrorEnum`jsx`({
            ...
            MissingClosingTagElement: (_ref72) => {
              let {
                openingTagName
              } = _ref72;
          ...
          var LValParser = class extends NodeUtils {
            ...
            checkLVal(expression, _ref74) {
              ...
              const nextAncestor = type2 === "ArrayPattern" || type2 === "ObjectPattern" || type2 === "ParenthesizedExpression" ? {
                type: type2
              } : ancestor;
            ...
            checkIdentifier(at, bindingType) {
              let strictModeChanged = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
          ...
          var TSErrors = ParseErrorEnum`typescript`({
            ...
            DuplicateAccessibilityModifier: (_ref78) => {
              let {
                modifier
              } = _ref78;
              return `Accessibility modifier already seen.`;
            },
            DuplicateModifier: (_ref79) => {
              let {
                modifier
              } = _ref79;
              return `Duplicate modifier: '${modifier}'.`;
            },
            EmptyHeritageClauseType: (_ref80) => {
              let {
                token
              } = _ref80;
            ...
            IndexSignatureHasAccessibility: (_ref82) => {
              let {
                modifier
              } = _ref82;
            ...
            PrivateElementHasAccessibility: (_ref87) => {
              let {
                modifier
              } = _ref87;
            ...
            SingleTypeParameterWithoutTrailingComma: (_ref88) => {
              let {
                typeParameterName
              } = _ref88;
            ...
            UnsupportedSignatureParameterKind: (_ref89) => {
              let {
                type: type2
              } = _ref89;
              return `Name in a signature must be an Identifier, ObjectPattern or ArrayPattern, instead got ${type2}.`;
            }
          });
          ...
          var typescript = (superClass) => class TypeScriptParserMixin extends superClass {
            ...
            tsParseModifiers(_ref90, modified) {
              let {
                allowedModifiers,
                disallowedModifiers,
            ...
            tsParseEntityName() {
              let allowReservedWords = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
            ...
            tsParseTypeAnnotation() {
              let eatColon = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
              let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.startNode();
              this.tsInType(() => {
                if (eatColon)
                  this.expect(14);
            ...
            parseVarStatement(node, kind) {
              let allowMissingInitializer = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
              const {
                isAmbientContext
              } = this.state;
          ...
          var ExpressionParser = class extends LValParser {
            ...
            isAmbiguousAwait() {
              ...
              return type2 === 53 || type2 === 10 || type2 === 0 || tokenIsTemplate(type2) || type2 === 101 && !this.state.containsEsc || type2 === 135 || type2 === 56 || this.hasPlugin("v8intrinsic") && type2 === 54;
            }
            parseYield() {
              const node = this.startNode();
          ...
          var StatementParser = class extends ExpressionParser {
            ...
            parseProgram(program) {
              let end = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 137;
              let sourceType = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : this.options.sourceType;
            ...
            parseStatementOrSloppyAnnexBFunctionDeclaration() {
              let allowLabeledFunction = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
              let flags = 0;
            ...
            parseBlock() {
              let allowDirectives = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
              let createNewLexicalScope = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
              let afterBlockParse = arguments.length > 2 ? arguments[2] : void 0;
              const node = this.startNode();
              if (allowDirectives) {
                this.state.strictErrors.clear();
              }
            ...
            parseVar(node, isFor, kind) {
              let allowMissingInitializer = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false;
            ...
            parseClassElementName(member) {
              ...
              if ((type2 === 130 || type2 === 131) && member.static && value === "prototype") {
            ...
            parseClassId(node, isStatement, optionalId) {
              let bindingType = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : BIND_CLASS;
              if (tokenIsIdentifier(this.state.type)) {
                node.id = this.parseIdentifier();
                if (isStatement) {
            ...
            isExportDefaultSpecifier() {
              ...
              if (tokenIsIdentifier(type2)) {
                ...
                if ((type2 === 128 || type2 === 127) && !this.state.containsEsc) {
                  const {
                    type: nextType
                  } = this.lookahead();
            ...
            isJSONModuleImport(node) {
              if (node.assertions != null) {
                return node.assertions.some((_ref91) => {
                  let {
                    key,
                    value
                  } = _ref91;
            ...
            finishImportSpecifier(specifier, type2) {
              let bindingType = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : BIND_LEXICAL;
      ...
      var require_json = __commonJS2({
        "src/language-js/parse/json.js"(exports2, module2) {
          "use strict";
          init_define_process();
          var isNonEmptyArray = require_is_non_empty_array();
          var createError = require_parser_create_error();
          var createParser2 = require_create_parser();
          var createBabelParseError2 = require_create_babel_parse_error();
          function createJsonParse() {
            let options = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            const {
              allowComments = true
            } = options;
            return function parse2(text) {
              const {
                parseExpression: parseExpression2
              } = require_lib();
              let ast;
              try {
                ast = parseExpression2(text, {
                  tokens: true,
                  ranges: true
                });
              } catch (error) {
                throw createBabelParseError2(error);
              }
          ...
          function createJsonError(node, description) {
            const [start, end] = [node.loc.start, node.loc.end].map((_ref92) => {
              let {
                line,
                column
              } = _ref92;
          ...
          function assertJsonNode(node) {
            switch (node.type) {
              ...
              case "UnaryExpression": {
                ...
                if (argument.type === "NumericLiteral" || argument.type === "Identifier" && (argument.name === "Infinity" || argument.name === "NaN")) {
                  return;
                }
                throw createJsonError(argument, `Operator '${operator}' before '${argument.type}'`);
              }
              case "Identifier":
                if (node.name !== "Infinity" && node.name !== "NaN" && node.name !== "undefined") {
                  throw createJsonError(node, `Identifier '${node.name}'`);
                }
                return;
              case "TemplateLiteral":
                if (isNonEmptyArray(node.expressions)) {
                  throw createJsonError(node.expressions[0], "'TemplateLiteral' with expression");
                }
          ...
          var jsonParsers2 = {
            ...
            json5: createParser2(parseJson),
            "json-stringify": createParser2({
              parse: createJsonParse({
                allowComments: false
              }),
              astFormat: "estree-json"
            })
          };
          module2.exports = jsonParsers2;
        }
      });
      init_define_process();
      ...
      var createBabelParseError = require_create_babel_parse_error();
      var postprocess = require_postprocess();
      var jsonParsers = require_json();
      var parseOptions = {
        sourceType: "module",
      ...
      var recordAndTuplePlugin = ["recordAndTuple", {
        syntaxType: "hash"
      }];
      var v8intrinsicPlugin = "v8intrinsic";
      var pipelineOperatorPlugins = [["pipelineOperator", {
        proposal: "hack",
        topicToken: "%"
      }], ["pipelineOperator", {
        proposal: "minimal"
      ...
      var appendPlugins = function(plugins) {
        let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : parseOptions;
        return Object.assign(Object.assign({}, options), {}, {
          plugins: [...options.plugins, ...plugins]
        });
      };
      var FLOW_PRAGMA_REGEX = /@(?:no)?flow\b/;
      function isFlowFile(text, options) {
        ...
        const firstNonSpaceNonCommentCharacterIndex = getNextNonSpaceNonCommentCharacterIndexWithStartIndex(text, 0);
      ...
      function parseWithOptions(parseMethod, text, options) {
        const parse2 = require_lib()[parseMethod];
        const ast = parse2(text, options);
        const error = ast.errors.find((error2) => !allowedMessageCodes.has(error2.reasonCode));
        if (error) {
          throw error;
        }
        return ast;
      ...
      function createParse(parseMethod) {
        for (var _len2 = arguments.length, optionsCombinations = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
          optionsCombinations[_key2 - 1] = arguments[_key2];
        }
        return function(text, parsers) {
          let opts = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
          if ((opts.parser === "babel" || opts.parser === "__babel_estree") && isFlowFile(text, opts)) {
          ...
          if (opts.__babelSourceType === "script") {
            combinations = combinations.map((options) => Object.assign(Object.assign({}, options), {}, {
              sourceType: "script"
            }));
          }
          if (/#[[{]/.test(text)) {
            combinations = combinations.map((options) => appendPlugins([recordAndTuplePlugin], options));
          }
          const shouldEnableV8intrinsicPlugin = /%[A-Z]/.test(text);
          if (text.includes("|>")) {
            const conflictsPlugins = shouldEnableV8intrinsicPlugin ? [...pipelineOperatorPlugins, v8intrinsicPlugin] : pipelineOperatorPlugins;
            combinations = conflictsPlugins.flatMap((pipelineOperatorPlugin) => combinations.map((options) => appendPlugins([pipelineOperatorPlugin], options)));
          } else if (shouldEnableV8intrinsicPlugin) {
            combinations = combinations.map((options) => appendPlugins([v8intrinsicPlugin], options));
          }
          const {
            result: ast,
            error
          } = tryCombinations(...combinations.map((options) => () => parseWithOptions(parseMethod, text, options)));
          if (!ast) {
      ...
      var parse = createParse("parse", appendPlugins(["jsx", "flow"]));
      var parseFlow = createParse("parse", appendPlugins(["jsx", ["flow", {
        all: true,
        enums: true
      }]]));
      var parseTypeScript = createParse("parse", appendPlugins(["jsx", "typescript"]), appendPlugins(["typescript"]));
      var parseEstree = createParse("parse", appendPlugins(["jsx", "flow", "estree"]));
      var parseExpression = createParse("parseExpression", appendPlugins(["jsx"]));
      var parseTSExpression = createParse("parseExpression", appendPlugins(["typescript"]));
      var allowedMessageCodes = /* @__PURE__ */ new Set(["StrictNumericEscape", "StrictWith", "StrictOctalLiteral", "StrictDelete", "StrictEvalArguments", "StrictEvalArgumentsBinding", "StrictFunction", "EmptyTypeArguments", "EmptyTypeParameters", "ConstructorHasTypeParameters", "UnsupportedParameterPropertyKind", "UnexpectedParameterModifier", "MixedLabeledAndUnlabeledElements", "InvalidTupleMemberLabel", "NonClassMethodPropertyHasAbstractModifer", "ReadonlyForMethodSignature", "ClassMethodHasDeclare", "ClassMethodHasReadonly", "InvalidModifierOnTypeMember", "DuplicateAccessibilityModifier", "IndexSignatureHasDeclare", "DecoratorExportClass", "ParamDupe", "InvalidDecimal", "RestTrailingComma", "UnsupportedParameterDecorator", "UnterminatedJsxContent", "UnexpectedReservedWord", "ModuleAttributesWithDuplicateKeys", "LineTerminatorBeforeArrow", "InvalidEscapeSequenceTemplate", "NonAbstractClassHasAbstractMethod", "UnsupportedPropertyDecorator", "OptionalTypeBeforeRequired", "PatternIsOptional", "OptionalBindingPattern", "DeclareClassFieldHasInitializer", "TypeImportCannotSpecifyDefaultAndNamed", "DeclareFunctionHasImplementation", "ConstructorClassField", "VarRedeclaration", "InvalidPrivateFieldResolution", "DuplicateExport"]);
      var babel = createParser(parse);
      var babelTs = createParser(parseTypeScript);
      var babelExpression = createParser(parseExpression);
      var babelTSExpression = createParser(parseTSExpression);
      module.exports = {
  ...
  return require_parser_babel_js_umd();
});