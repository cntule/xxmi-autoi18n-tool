...
module.exports = async function initFileConf(programOption) {
  await doInquire();
  const autoi18nConfig = fs.readFileSync(
    path.resolve(__dirname, "../utils/autoi18n.config.js"),
    { encoding: "utf8" }
  );
  ...
  fs.writeFileSync(
    "./autoi18n.config.js",
    prettier.format(autoi18nConfig, {
      parser: "babel",
      singleQuote: true,
      trailingComma: "es5",
    }),
  ...
  log.success("autoi18n.config.js配置文件创建成功");
  //
  // // 创建生成国际化文件对象
