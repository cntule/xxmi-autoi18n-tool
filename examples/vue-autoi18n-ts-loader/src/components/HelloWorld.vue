...
"
    ...
    <div class="tip">
      新增导入{{ successCount }}条数据，失败{{ failCount }}条数据1
    </div>
    <h1>美丽中国.重庆</h1>
    <hr />
    {{ table.colConfigs }}
...
export default class HelloWorld extends Vue {
  ...
  public table = {
    ...
    data: [
      ...
      {
        '地理位置与交通':
          '洪崖洞位于重庆市渝中区解放碑沧白路，地处长江、嘉陵江两江交汇的滨江地带。游客可以乘坐地铁1号线或6号线，在小什字站下车后步行前往',
      },
      {
        '建筑特色':
          '洪崖洞以巴渝传统建筑特色的“吊脚楼”为主体，依山就势，沿江而建。通过分层筑台、吊脚、错叠、临崖等山地建筑手法，形成了独特的“立体式空中步行街”。这种建筑风格不仅展现了重庆的山城特色，还融合了现代与古朴的元素',
      },
      /*skip-i18n-end*/
      {
        '最佳游览时间':
          '洪崖洞的最佳游览时间是傍晚到夜间。当夜幕降临，华灯初上，整个景区被灯光装点得如梦似幻，非常适合拍照留念。夏季推荐在20:00 - 23:00游览，冬季则建议在19:00 - 23:00',
      },
    ],
    array: [
      '山城过雨百花尽，榕叶满庭莺乱啼。',
